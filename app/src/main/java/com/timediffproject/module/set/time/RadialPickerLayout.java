...
package com.timediffproject.module.set.time;
...
import com.timediffproject.module.set.time.utils.TimeAnimationUtils;
import com.timediffproject.module.set.time.utils.Utils;
...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
    ...
    public void setCurrentItemShowing(int index, boolean animate) {
        ...
        if (animate && (index != lastIndex)) {
            ...
            if(TimeAnimationUtils.isHC())
            {
            	mHourRadialTextsView.setAlpha((float)hourAlpha/255);
                mHourRadialSelectorView.setAlpha((float)hourAlpha/255);
                mMinuteRadialTextsView.setAlpha((float)minuteAlpha/255);
                mMinuteRadialSelectorView.setAlpha((float)minuteAlpha/255);
            }else
            {
            	ViewHelper.setAlpha(mHourRadialTextsView,hourAlpha);
            	ViewHelper.setAlpha(mHourRadialSelectorView,hourAlpha);
            	...
            	/*TimeAnimationUtils.setAlphaForView(mHourRadialTextsView, hourAlpha);
            	TimeAnimationUtils.setAlphaForView(, hourAlpha);
            	TimeAnimationUtils.setAlphaForView(, minuteAlpha);
            	TimeAnimationUtils.setAlphaForView(, );*/
            }
